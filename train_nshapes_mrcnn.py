...
##------------------------------------------------------------------------------------
parser = argparse.ArgumentParser(description='Train Mask R-CNN on NewShapes.')
...
print(' config.BATCH_SIZE      : ', mrcnn_config.BATCH_SIZE)
print(' model.config.BATCH_SIZE: ', mrcnn_model.config.BATCH_SIZE)
# exit(8)
