...
def fcn32_graph(feature_map , config):
    ...
    x = KL.Deconvolution2D(num_classes, kernel_size=(32,32), strides = (32,32),
                           kernel_initializer='glorot_uniform', bias_initializer='zeros',
                           padding = "valid", activation = None, name = "fcn32_classify")(x)
    print()
    print('   FCN fcn32_classify (Deconv(fcn32_deconv2D)) shape is : ' , KB.int_shape(x),
