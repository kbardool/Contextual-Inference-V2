...
from mrcnn.prep_notebook  import mrcnn_coco_train, build_coco_config
...
##------------------------------------------------------------------------------------
mrcnn_config = build_coco_config('mrcnn','trainfcn', args, verbose = 1)
...
##------------------------------------------------------------------------------------
fcn_config = build_coco_config('fcn','training', args, verbose = 1)
